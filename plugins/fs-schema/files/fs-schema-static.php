...
class fs_schema_static {
	...
	public static function get_date_from_string ( $string, $debug = false ) {
		...
		if ( isset ( $date_time_parts[0] ) && isset ( $date_time_parts[1] ) && !isset ( $date_time_parts[2] )) {
			...
			if ( isset( $date_parts[0] ) && isset( $date_parts[1] ) && isset( $date_parts[2] ) && !isset( $date_parts[3] ) && isset( $time_parts[0] ) && isset( $time_parts[1] ) ) {
